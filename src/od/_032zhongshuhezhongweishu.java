...
/**
 * @ClassName _032zhongshuhezhongweishu
 * @Description TODO 众数和中位数
 * 题目描述
 * 众数是指一组数据中出现次数多的数
 * 众数可以是多个
 ...
 * @Date 2023/3/7 17:04
 */
public class _032zhongshuhezhongweishu {
    public static void main(String[] args) {
        ...
        int size = res.size();
        if(size%2==1){
            System.out.println(res.get((size-1)/2));
        }else{
            System.out.println((res.get(size/2)+res.get(size/2-1))/2);
        }
    }
}